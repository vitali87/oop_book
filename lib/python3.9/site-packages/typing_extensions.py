...
class _ExtensionsGenericMeta(GenericMeta):
    def __subclasscheck__(self, subclass):
        ...
        """
        if (
            sys.version_info[:3] >= (3, 5, 3) or sys.version_info[:3] < (3, 5, 0)
        ) and self.__origin__ is not None:
...
if hasattr(typing, 'ContextManager'):
    ...
    class ContextManager(typing.Generic[T_co]):
        ...
        def __subclasshook__(cls, C):
            if cls is ContextManager and (
                any("__enter__" in B.__dict__ for B in C.__mro__)
...
Text = typing.Text if hasattr(typing, 'Text') else str
